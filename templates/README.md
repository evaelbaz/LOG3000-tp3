...
Ce module contient un seul fichier, soit index.html. Le fichier décrit la structure HTML de la calculatrice. Il affiche les éléments interactifs (boutons, écran) et les messages d’erreur. Il implémente également les fonctions JavaScript responsables de la mise à jour de l’écran et formule les requêtes HTTP destinées au backend.
